...
Doctores: Perfil con fotos; al click, desplegar historial del doctor.

Servicios: Lista con descripción y precio; botón "Agendar" que lleva al formulario.

Citas y Pago: Pantalla de selección de horario -> Pantalla de pago (monto y método) -> Pantalla de confirmación con ticket.

Historial: Lista cronológica de citas del usuario autenticado.
